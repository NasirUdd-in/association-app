...
urlpatterns = [
    ...
    path('dps-opening-report/', views.dps_opening_report, name='dps_opening_report'),
    path('dps-schemes/', views.dps_schemes, name='dps_schemes'),
    path('dps-withdraw-report/', views.dps_withdraw_report, name='dps-withdraw-report'), 
   ...
   #fdr
    ...
    path('fdr-opening-report/', views.fdr_opening_report, name='fdr_opening_report'),
    path('fdr-schemes/', views.fdr_schemes, name='fdr_schemes'),
    path('fdr-withdraw-report/', views.fdr_withdraw_report, name='fdr_withdraw_report'),
   ...
   #loan
    ...
    path('report-by-employee/', views.report_by_employee, name='report_by_employee'),
