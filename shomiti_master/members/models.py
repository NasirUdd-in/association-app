...
class Employee(models.Model):
    ...
    husband_or_wife_name = models.CharField(max_length=100, blank=True, null=True)
...
class EmployeeLogin(models.Model):
    ...
    login_permission = models.CharField(max_length=10, choices=LOGIN_PERMISSION_CHOICES, default='active')
